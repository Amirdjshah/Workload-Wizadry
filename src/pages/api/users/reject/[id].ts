...
import { signUpRequestReject } from "../../../../../components/server/utils/email";
...
const postHandler = async (
  ...
  try {
    ...
    // const emailSent = await signUpRequestReject(findUser.email, {
    ...
    res
      ...
      .json({
        message:
          "This User has already created a workload so you can't delete this user.",
      });
